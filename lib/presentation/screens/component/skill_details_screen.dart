...
import 'iquiz_screen.dart';
class ISkillDetailsScreen extends StatefulWidget {
  final String skillName;
  final String skillName2;
  final String videoUrl;
  final String audioUrl;
  const ISkillDetailsScreen({
    Key? key,
  ...
  @override
  State<ISkillDetailsScreen> createState() => _ISkillDetailsScreenState();
}

class _ISkillDetailsScreenState extends State<ISkillDetailsScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return BlocProvider(
      create: (context)=>sl<HomeBloc>()..add(GetSkillDetailsDataEvent(skillName: widget.skillName,skillName2: widget.skillName2)),
                    ...
                    child: Row(
                      children:  [
                        ...
                        InkWell(
                          ...
                          onTap: (){
                            // navigateTo(context,const IQuizScreen());
                          },
                        ),
                      ],
                    ),
